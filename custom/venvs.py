...
from custom.dummy import DummyEnvWorker_custom

class BaseVectorEnv_custom(gym.Env):
...
class DummyVectorEnv_custom(BaseVectorEnv_custom):
    ...
    def __init__(self, env_fns: List[Callable[[], gym.Env]], **kwargs: Any) -> None:
        super().__init__(env_fns, DummyEnvWorker_custom, **kwargs)