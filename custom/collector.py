...
from custom.venvs import BaseVectorEnv_custom, DummyVectorEnv_custom


class Collector_custom(object):
    ...
    def __init__(
        self,
        policy: BasePolicy,
        env: Union[gym.Env, BaseVectorEnv_custom],
        ...
        if isinstance(env, gym.Env) and not hasattr(env, "__len__"):
            ...
            env = DummyVectorEnv_custom([lambda: env])
        self.env = env
