...
class BasePolicy_custom(ABC, nn.Module):
    ...
    * :meth:`~tianshou.policy.BasePolicy.update`: the main interface for training, \
    ...
    def update(self, sample_size: int, buffer: Optional[ReplayBuffer_custom],
    ...
    def compute_episodic_return(
        ...
        if v_s_ is None:
            ...
            v_s_ = v_s_ * BasePolicy_custom.value_mask(buffer, indices)
    ...
    def compute_nstep_return(
        ...
        target_q = target_q * BasePolicy_custom.value_mask(buffer, terminal).reshape(-1, 1)
